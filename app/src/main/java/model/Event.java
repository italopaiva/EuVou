...
public class Event {
    ...
    public Event(int idEvent,String nameEvent,String dateTimeEvent,String adress, String description,String latitude, String longitude, Vector<String> category) throws EventException, ParseException {
        setIdEvent(idEvent);
